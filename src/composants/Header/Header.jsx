...
export default function Header() {
  return (
    <div>
      <nav>
      <img src='src/assets/logo.png' alt='logo.png' style={{width:"30%", height:"5rem"}} className="object-cover"/>
        <NavLink to="/">
          <a className="d-block bg-primary-4 text-white fs-3 no-underline" style={{textDecoration:"none"}}>La Grange de l’Ainan</a>
        </NavLink>
