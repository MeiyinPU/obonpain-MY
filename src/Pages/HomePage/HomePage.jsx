...
export default function PageAccueil() {
  return (
    <div>
      <Header />
    <div className="m-2 p-2 bg-primary-1 opacity-75">
      {/* <div>
      ...
      <h2 className="text-primary-4">Bienvenue</h2>
      ...
      <div className="d-flex justify-content-evenly mt-4">
          <a href="/connexion" className="primary-3 mt-3 text-primary-4">Nouveau client ?</a>
